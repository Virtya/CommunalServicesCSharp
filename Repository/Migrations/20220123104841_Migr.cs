    ...
    public partial class Migr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentDoсs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentDoсs_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentDoсs_Contracts_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDoсs_ClientId",
                table: "PaymentDoсs",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDoсs_ContractId",
                table: "PaymentDoсs",
                column: "ContractId");
        }
